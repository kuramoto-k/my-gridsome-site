<template>
<div class="footer-layout mt-24 px-2 md:px-0">
  <footer class="mx-auto max-w-screen-lg">
    <div>
      <div class="text-gray-800 flex flex-wrap justify-between">
          <div class="p-5 w-48 ">
            <div class="text-xs uppercase text-gray-500 font-medium">ホーム</div>
          ...
          <div class="p-5 w-48 ">
            <div class="text-xs uppercase text-gray-500 font-medium">メニュー</div>
          ...
          <div class="p-5 w-48 ">
            <div class="text-xs uppercase text-gray-500 font-medium">サポート</div>
          ...
          <div class="p-5 w-48 ">
            <div class="text-xs uppercase text-gray-500 font-medium">店舗情報</div>
...
<style lang="postcss" scopde>
.footer-layout {
  @apply w-full shadow pt-8 pb-2 border-t;
}
/* .footer {
  @apply flex items-center mb-6 mx-auto px-4 max-w-screen-lg;
} */
</style>
